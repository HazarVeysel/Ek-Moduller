...
namespace ExceleGetir.Models
{
    ...
    public partial class Tbl_HavaLoads
    {
        ...
        public string cmbodemesekli { get; set; }
        public string txtnavluntutari { get; set; }
        public string cmbnavlundoviz { get; set; }
        ...
        public Nullable<double> IATARate { get; set; }
        public Nullable<double> MinimumRate { get; set; }
